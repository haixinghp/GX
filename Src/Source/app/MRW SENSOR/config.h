...
#define VERSION_NUM                         {'1','0','0','1','0','3', '0' + COMPLING_OPTION / 10, '0' + COMPLING_OPTION % 10}
...
#define PROTOCOL_MICROARRAY_COMPATIBLE_YALE     (0x03)
    ...
    #define SPI_FLASH_SIZE				(2 * 1024 * 1024)
...
#define CODE_LENGTH                         (128+12)
#define SEARCH_ALL_FIDS                     0xffff
