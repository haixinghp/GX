...
/*************************专用宏定义*************************/
#define DRV_KEY_SACN_GT316L_I2C_WRITE_ADDR (0XB2)
#define DRV_KEY_SACN_GT316L_I2C_READ_ADDR (DRV_KEY_SACN_GT316L_I2C_WRITE_ADDR+1)
...
#define DRV_KEY_SACN_EXT extern
    ...
    DRV_KEY_SACN_EXT uint8_t DRV_KeySacn_PwmOut(uint8_t dat);
#ifdef __cplusplus
}
#endif /*__cplusplus*/
